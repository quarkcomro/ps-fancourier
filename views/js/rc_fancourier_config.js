...
$(function () {
    $(document).ready(function () {
        $('#RC_FANCOURIER_FREETEXT1, #RC_FANCOURIER_FREETEXT2, #RC_FANCOURIER_FREETEXT3, #RC_FANCOURIER_FREETEXT4, #RC_FANCOURIER_FREETEXT5').closest('.form-group').addClass('alert alert-info rc_fancourier_heading');
        $(function () {
