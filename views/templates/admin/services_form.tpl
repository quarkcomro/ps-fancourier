    ...
    <form id="rc_fancourier_services_form" method="POST">
        <table id="rc_fancourier_services_table" class="table">
            ...
            <tr>
                ...
                <th>
                    {l s='Free shipping from (optional)' mod='rc_fancourier'}
                </th>
                <th>
            ...
            {foreach from=$carriers item=carrier}
                <tr>
                    ...
                    <td>
                        <input type="text" name="rc_fancourier_services[free_shipping_from][]" value="{$carrier.free_shipping_from|escape:'htmlall':'UTF-8'}" placeholder="RON" style="width:80px;" title="{l s='Leave empty to use global or group free shipping. If set, this threshold applies regardless of customer group.' mod='rc_fancourier'}"/>
                    </td>
                    <td>
